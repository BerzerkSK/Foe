<?php
// source: D:\Programy\xampp\htdocs\foe\app/config/config.neon 
// source: D:\Programy\xampp\htdocs\foe\app/config/config.local.neon 

class Container_ccca682779 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\CechPresenter' => [1 => ['application.1']],
			...
			'App\Presenters\PrispevokPresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'application.1' => 'App\Presenters\CechPresenter',
			...
			'application.5' => 'App\Presenters\PrispevokPresenter',
	...
	{
		parent::__construct([
			'appDir' => 'D:\Programy\xampp\htdocs\foe\app',
			'wwwDir' => 'D:\Programy\xampp\htdocs\foe\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'D:\Programy\xampp\htdocs\foe\app/../temp',
		]);
	}
	...
	/**
	 * @return App\Presenters\CechPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\CechPresenter($this->getService('database.default.context'));
	...
	/**
	 * @return App\Presenters\PrispevokPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\PrispevokPresenter($this->getService('database.default.context'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\Programy\xampp\htdocs\foe\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\Programy\xampp\htdocs\foe\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\Programy\xampp\htdocs\foe\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=foe', 'root',
			NULL, ['lazy' => TRUE]);
	...
	{
		return new Container_ccca682779_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_ccca682779_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_ccca682779 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\Programy\xampp\htdocs\foe\app/../temp/cache/latte');
